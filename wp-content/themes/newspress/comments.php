...
<?php if ( have_comments() ) : ?>
	...
	<h2 class="commh2"><?php comments_number('No Responses', 'One Response', '% Responses' );?> to &#8220;<?php the_title(); ?>&#8221;</h2>
    ...
    <h2 class="commh2" id="pings">Trackbacks/Pingbacks</h2>
    <ol class="commentlist">
...
<h2 class="commh2"><?php comment_form_title( 'Leave a Reply', 'Leave a Reply to %s' ); ?></h2>
