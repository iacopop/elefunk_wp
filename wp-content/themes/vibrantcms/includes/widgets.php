...
register_sidebar_widget('Company / Product News (Home)', 'newsWidget');
...
register_sidebar_widget('More Info (Home) #1', 'moreinfo1Widget');
register_widget_control('More Info (Home) #1', 'moreinfo1WidgetAdmin', 400, 200);
...
register_sidebar_widget('More Info (Home) #2', 'moreinfo2Widget');
register_widget_control('More Info (Home) #2', 'moreinfo2WidgetAdmin', 400, 200);
