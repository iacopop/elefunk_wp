		...
		<div class="inner">
			...
			?>			
				...
				<div class="item <?php if ( $i == 3 ) { echo 'last'; } ?>">
					...
					<p><?php if ( get_post_meta($post->ID, "page_excerpt", $single = true) <> "" ) { echo get_post_meta($post->ID, "page_excerpt", $single = true); } else { the_excerpt(); } ?> <a class="more_info" href="<?php the_permalink(); ?>" title="<?php the_title(); ?>">More Info</a></p>
