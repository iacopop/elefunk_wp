   ...
   <li <?php comment_class(); ?> id="comment-<?php comment_ID() ?>">
							...
							<div class="comment_meta">
								...
								<div class="details">
									...
									<?php if(get_comment_type() == "comment") { ?><span class="date"><?php echo get_comment_date("j F Y"); ?> at <?php echo get_comment_time(); ?> <a href="<?php echo get_comment_link(); ?>" title="Direct link to this comment">(PERMALINK)</a></span><?php } ?>
								</div><!-- /.details -->
							...
							<span class="author_id">Author</span>
