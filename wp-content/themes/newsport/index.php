<?php get_header(); ?>
        	...
        	<div id="content">
                ...
                <!-- MPU 300x300 ad -->
				<?php if (get_option('woo_ad_300')  == 'true' && get_option('woo_ad_300_bot')  == 'false' ) { if (get_option('woo_ad_300_adsense') <> "") echo stripslashes(get_option('woo_ad_250_adsense')); else { ?>
