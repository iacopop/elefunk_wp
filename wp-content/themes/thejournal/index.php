<?php get_header(); ?>
 <?php $featured_tag = get_settings('woo_featured_tag');  ?>      
    ...
    <div id="content" class="wrap">
            ...
            <div class="threecol_three">
                ...
                $counter++; ?>
                 ...
                 ?>
                   <?php  if(!empty($featured_tag)){ 
                    ...
                    $term_id = (int)$result;
                   ?>
                    <p>Go to the <a href="<?php echo get_tag_link($term_id); ?>">Archives</a> to see more entries</p>	
                    <?php } ?>
             ...
             <?php if(get_settings('woo_also_slider_enable') == 'true'){ ?>   
            ...
            <div id="also">
               ...
               <div id="also-header">
                    ...
                    <div class="carousel-nav">
                    	<img class="back" src="<?php bloginfo('template_directory'); ?>/images/carousel_back_button.gif" alt="Previous Posts" />
                        <img class="next" src="<?php bloginfo('template_directory'); ?>/images/carousel_next_button.gif" alt="Next Posts" />
                    </div>
                    <div class="fix"></div>
                </div>
