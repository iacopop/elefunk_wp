	...
	<div id="wrap">
        ...
        <div id="nav_wrapper">
            <ul id="nav">
                ...
                <li <?php if ( is_category() || is_single() || is_tag() || is_archive() ) { ?> class="current_page_item" <?php } ?>><a href="<?php echo get_option('home'); echo get_option('woo_blog_permalink'); ?>" title="Blog"><span class="left"></span>Blog<span class="right"></span></a></li><?php } ?>
                
                <?php if ( get_option('woo_blog_subnavigation') == 'true' && get_option('woo_blog_navigation' ) =='true' ) { ?><?php wp_list_categories('child_of=' . get_option( 'woo_blog_cat' ) . '&hide_empty=&title_li=<a href="' . get_option('home') . get_option('woo_blog_permalink') .'" title="Blog"><span class="left"></span>Blog<span class="right"></span></a>'); ?><?php } ?>
		...
		<div id="header">
            ...
            <?php }
              ...
              ?>
              <div id="button"> 
                        <img src="<?php bloginfo('stylesheet_directory'); ?>/<?php woo_style_path(); ?>/button.png" width="184" height="32" alt="" class="menu_class" />
                        <ul class="the_menu">
