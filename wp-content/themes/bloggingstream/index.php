<?php get_header(); ?>
	...
	<div id="featured">
		...
		<span class="heading">Latest Article</span>
		...
		<div id="left">
			...
			<div id="more_posts" class="box">
				...
				<div class="item <?php if ( $count == 1 ) { ?>left<?php } ?>">
					...
					<p><?php woo_get_image('image',get_option('woo_thumb_width'),get_option('woo_thumb_height'),''); ?> <?php the_excerpt(); ?> <a class="read_more" href="<?php the_permalink(); ?>" title="<?php the_title(); ?>">Read more &rarr;</a></p>
