...
<span class="heading"><?php comment_form_title( 'Leave a Reply', 'Leave a Reply to %s' ); ?></span>
...
<div class="textarea">
	<textarea rows="10" cols="50" name="comment" tabindex="4" onfocus="if (this.value == 'Type your comment here...') {this.value = '';}" onblur="if (this.value == '') {this.value = 'Type your comment here...';}">Type your comment here...</textarea>
</div><!-- /textarea -->
