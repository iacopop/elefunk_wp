...
function the_widgets_init() {
    ...
    register_sidebars(1,array('name' => 'Sidebar','before_widget' => '<div id="%1$s" class="last block widget %2$s">','after_widget' => '</div>','before_title' => '<h2>','after_title' => '</h2>'));
    register_sidebars(3,array('name' => 'Footer %d','before_widget' => '<div id="%1$s" class="last block widget %2$s">','after_widget' => '</div>','before_title' => '<h2>','after_title' => '</h2>'));
