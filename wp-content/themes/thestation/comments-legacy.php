	...
	<li class="comment <?php echo $oddcomment; ?>" id="comment-<?php comment_ID() ?>">
		...
		<div id="div-comment-<?php comment_ID() ?>">
			...
			<div class="comment-author vcard">
				<img src="<?php gravatar('X', '40'); ?>" alt="<?php _e('Gravatar'); ?>" />
				
				<cite class="fn"><?php comment_author_link() ?></cite> <span class="says">says:</span>
			</div>

			<div class="comment-meta commentmetadata">
				<a href="#comment-<?php comment_ID() ?>" title="Permalink For this Comment"><?php comment_date('d. M, Y'); ?> <?php _e('at');?> <?php comment_time() ?>&nbsp;&nbsp;<?php edit_comment_link('Edit Comment','',''); ?></a>
			</div>
...
<input name="submit" type="submit" tabindex="5" value="submit" class="sb" />
<?php else : ?>
