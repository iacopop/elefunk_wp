...
<?php if ('open' == $post->comment_status) : ?>
	...
	<div id="respond">
		...
		<p><textarea name="comment" id="comment"  rows="10" tabindex="4" cols=""></textarea></p>
		
		<p style="margin-bottom:0;"><input name="submit" type="submit" id="submit" tabindex="5" value="Submit Comment" />
