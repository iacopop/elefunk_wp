<div class="wrap blog" id="col_4">
                
    <?php 
            $height = get_option('woo_4col_height');
    //The Query
         if (have_posts()) :
   ...
   <div class="box <?php echo $postclass ?>" >
             ...
             <?php if(get_option('woo_port_images') == 'true') 
                { 
                    mortar_get_image('image','198',null,'thumbnail',90,get_the_id(),'src',1,0,'','',false,true,false,true); } 
                else 
                {
                    woo_get_image('image','198',$height);
                } ?>
