...
function woothemes_meta_box() {
	if ( function_exists('add_meta_box') ) {
		add_meta_box('woothemes-settings', get_option('woo_custom_template') .' Custom Settings','woothemes_meta_box_content','post','normal');
		add_meta_box('woothemes-settings', get_option('woo_custom_template') .' Custom Settings','woothemes_meta_box_content','page','normal');
	}
}
