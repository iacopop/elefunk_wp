...
?>
    ...
    <div class="slide slide-<?php echo $counter; ?> slide-full">
        ...
        <a href="<?php the_permalink() ?>" title="Read the full story" class="open"><?php woo_get_image('image','595', '270','full',90,get_the_id(),'img'); ?></a>   
    ...
    <?php woo_get_image('image','595', '270','full-mask full-mask-' . $counter,90,get_the_id(),'img'); ?>
