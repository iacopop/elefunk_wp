...
/* Slider */
    ...
    {
       jQuery('#slider-holder .slider-shelf').add('#slider-holder #slider-nav').add('#slider-holder .shelf-content').hide();   
    ...
    jQuery('#slider-holder .slide-content-1').css('opacity','0').css('top','270px');
    var content_height = jQuery('#slider-holder .slide-content-height-1').height();
    var cut_from_top = 250 - content_height;
    ...
    jQuery('#slider-nav .slider-right').click(function(evt){
        ...
        jQuery('#slider-holder .slide-content').css('top','270'); // Keps the correct mask shown
        ...
        //Prep Slider Content
        jQuery('#slider-holder .slide-content-' + target_slide).css('z-index',counter).css('opacity','0').css('top','270px');
...
// --------------------------- CLICK FUNCTIONS - REVERSE------------------------------
    ...
    jQuery('#slider-nav .slider-left').click(function(evt){
        ...
        function content_stuff_left(){
            ...
            var cut_from_top = 250 - content_height;
            if(jQuery.browser.msie){
                  jQuery('#slider-holder .slide-content-' + target_slide).css('z-index',counter).css('opacity',1).css('top','270px').css('left','0');
                  jQuery('#slider-holder .slide-content-' + target_slide).animate({ 'top':cut_from_top},1000);
            }
            else
            {
                jQuery('#slider-holder .slide-content-' + target_slide).css('z-index',counter).css('opacity','0').css('top','270px').css('left','0');
                 jQuery('#slider-holder .slide-content-' + target_slide).animate({ 'top':cut_from_top,opacity:0.8},1000);
            }
