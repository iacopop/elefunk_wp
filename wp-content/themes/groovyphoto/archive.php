		...
		<div class="col-left">
            ...
            <?php while (have_posts()) : the_post(); $count++; ?>
                ...
                <div class="post wrap">
                   ...
                   <div class="img archive-thumb">
                    
                        <?php 
                        $index_width = get_option('woo_archive_image_w');
                        woo_get_image('image',$index_width,null);      
                         ?>
                    
                    </div><!-- /.img -->

                    <h2><a href="<?php the_permalink() ?>" rel="bookmark" title="<?php the_title(); ?>"><?php the_title(); ?></a></h2>
                    <p class="post-details">Posted on <?php the_time('F d, Y'); ?> by  <?php the_author_posts_link(); ?> in <?php the_category(', ') ?> | <?php comments_popup_link(); ?></p>
