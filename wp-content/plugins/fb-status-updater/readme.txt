...
Tags: facebook, status, wall, update, social networks, marketing, social network marketing, twitter, myspace
Requires at least: 2.5.1
Tested up to: 2.9
Stable tag: 1.5.6

If you have a company Facebook profile or page or group, or a company Twitter or Myspace account, this plugin is what you need to connect them with your company blog! When you publish a new wordpress article, the Status Updater plugin will update the Facebook status, page wall, group wall, tweet with the post title and url.

== Description ==

Instead of manually update your **Facebook status** / **Fan Page Wall** / **Group Page Wall** / **Twitter** / **Myspace** with every new post you publish on your blog, this plugin does it for you.   
